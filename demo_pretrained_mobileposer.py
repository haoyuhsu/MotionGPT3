...
def main():
    ...
    def predict_text_from_motion(motion_feats, lengths):
        ...
        tasks = [{
            ...
            'input': ['Describe the motion in <Motion_Placeholder> using natural language.'],
            'output': ['']
        }] * len(lengths)
        texts = [''] * len(lengths)
    ...
    # motion_feat_list = [
    #     '/projects/benk/hhsu2/imu-humans/related_works/Mocap-to-SMPLX/tmp_our_data_output/motion_263.npy',
    #     # "datasets/humanml3d/new_joint_vecs/M000091.npy",
    #     # "datasets/humanml3d/new_joint_vecs/001128.npy",
    #     # "datasets/humanml3d/new_joint_vecs/009547.npy",
    #     # "datasets/humanml3d/new_joint_vecs/M013887.npy",
    # ]
    ...
    for motion_feat_path in tqdm(motion_feat_list, desc="Processing motions"):
        ...
        motion_feats = motion_feats.unsqueeze(0)  # (bs, motion_length, 263)
